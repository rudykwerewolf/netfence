...
func forwardForm(app *tview.Application, pages *tview.Pages) tview.Primitive {
        ...
        form.AddInputField("Destination IP", "", 20, nil, func(s string) { dstIP = s })        form.AddInputField("Sport", "", 10, nil, func(s string) { sport = s })
...
func main() {
        ...
        menu := tview.NewList().
                ...
                AddItem("Add NAT Rule", "", '2', func() { pages.SwitchToPage("nat") }).                AddItem("Add Port Forwarding", "", '3', func() { pages.SwitchToPage("portfwd") }).
                ...
                AddItem("Save & Exit", "", 's', func() { persist(pages); app.Stop() }).                AddItem("Exit without saving", "", 'q', func() { app.Stop() })
